...
>**`Volatile`** (experiments, this removes all UI, auto-unmutes, and removes all errors): [v4.0.0](https://github.com/ancandi/YouTube-Mobile-URL-Shield-AB/raw/refs/heads/main/url-shield-ab+-test-beta.user.js)
