...
(function(d, w) {
    ...
    s.textContent = 'ytd-ad-slot-renderer,ytm-ad-slot-renderer,.ad-showing,.ad-interrupting,.ytp-ad-overlay-container,ytd-rich-section-renderer:has(ytd-ad-slot-renderer){display:none!important}';
    ...
    (function loop() {
        ...
        if (isW && v) {
            (v.readyState == 0 || v.networkState == 3) ? (++g > 70 && (w.dispatchEvent(new PopStateEvent('popstate')), g = 0)) : (g = 0);
